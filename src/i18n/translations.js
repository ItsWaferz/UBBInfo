...
const translations = {
  ...
  'nav.documents': { ro: 'Documente', en: 'Documents', hu: 'Dokumentumok', de: 'Dokumente' },
  ...
  'nav.grading': { ro: 'Notare', en: 'Grading', hu: 'Értékelés', de: 'Benotung' },
  ...
  'admin.tab.rooms': { ro: 'Clădiri & săli', en: 'Buildings & rooms', hu: 'Épületek & termek', de: 'Gebäude & Räume' },
